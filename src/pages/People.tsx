...
export function HR() {
  ...
  return (
    <div>
      <PageHeader title="HR & Payroll" breadcrumb={[{ label: 'Home', to: '/' }, { label: 'HR & Payroll' }]} actions={<Button><Plus size={15} /> New Employee</Button>} tabs={<Tabs tabs={['Employees', 'Departments', 'Attendance', 'Leave', 'Payroll', 'Payslips', 'Documents']} active={tab} onChange={setTab} />} />
...
export function CRM() {
  ...
  return (
    <div>
      <PageHeader title="CRM" breadcrumb={[{ label: 'Home', to: '/' }, { label: 'CRM' }]} actions={<Button><Plus size={15} /> New Lead</Button>} tabs={<Tabs tabs={['Pipeline', 'Leads', 'Opportunities', 'Activities', 'Tasks']} active={tab} onChange={setTab} />} />
      {tab === 'Pipeline' ? (
...
export function Projects() {
  ...
  return (
    <div>
      <PageHeader title="Projects" breadcrumb={[{ label: 'Home', to: '/' }, { label: 'Projects' }]} actions={<Button><Plus size={15} /> New Project</Button>} tabs={<Tabs tabs={['Projects', 'Tasks', 'Milestones', 'Timesheets', 'Expenses']} active={tab} onChange={setTab} />} />
